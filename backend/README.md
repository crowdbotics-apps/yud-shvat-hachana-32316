...
## Project Structure
    ...
    ├── yud_shvat_hachana_32316  # Django project configurations
...
1. Clone this repo and `cd yud_shvat_hachana_32316`
...
2. Clone this repo and `cd yud_shvat_hachana_32316`
